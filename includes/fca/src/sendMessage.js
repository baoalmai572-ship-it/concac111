 ...
 * 21/4/2022
 * Updated: Fix for Facebook 17-digit group ID
*/
  ...
  function send(form, threadID, messageAndOTID, callback, isGroup) {
    ...
    if (utils.getType(threadID) === "Array") {
      ...
      // New logic to handle both 15-17 digit IDs
        ...
        //   }
        // }
        // Group IDs are 16-17 digits (updated to support new 17-digit format)
        //else if (threadLength >= 16 && threadLength <= 17) {
          // Additional check: group IDs typically don't start with '1'
          var isLikelyGroup = true;// THREADFIX.indexOf('1') !== 0 || threadLength === 17;
        ...
        // }
        // Fallback: use event data or isGroup parameter
        // else {
        ...
        //     }
        //   } else {
        //     var isSingleUser = isGroup !== null ? !isGroup : true;
